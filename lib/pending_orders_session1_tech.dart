...
import 'pending_orders_session2.dart';
import 'pending_orders_session2_tech.dart';

class PendingOrdersSession1Tech extends StatefulWidget {
  @override
  _PendingOrdersSession1TechState createState() => _PendingOrdersSession1TechState();
}

class _PendingOrdersSession1TechState extends State<PendingOrdersSession1Tech> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PendingOrdersSession2Tech(),
                        ),
                      );
                    },
                ...
                // // Reject Button
                // SizedBox(
                //   width: 80, // Fixed width for the Reject button
                //   child: ElevatedButton(
                //     onPressed: () {
                //       // Reject action
                //     },

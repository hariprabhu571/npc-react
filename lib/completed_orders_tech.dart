...
class CompletedOrdersTech extends StatefulWidget {
  @override
  _CompletedOrdersTechState createState() => _CompletedOrdersTechState();
}

class _CompletedOrdersTechState extends State<CompletedOrdersTech> {

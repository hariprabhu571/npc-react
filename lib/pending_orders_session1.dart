...
class PendingOrdersSession1 extends StatefulWidget {
  @override
  _PendingOrdersSession1State createState() => _PendingOrdersSession1State();
}

class _PendingOrdersSession1State extends State<PendingOrdersSession1> {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PendingOrdersSession2(),
                        ),
                      );
                    },
